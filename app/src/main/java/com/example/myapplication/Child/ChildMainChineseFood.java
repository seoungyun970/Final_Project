...
public class ChildMainChineseFood extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_childmain_chinesefood);
        recyclerView = findViewById(R.id.brecycler_view);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0, j=jsonArrayArticles.length(); i<j; i++){
                                ...
                                String a=object.getString("food");
                                if(a.equals("중식")){
                                    storeVOS.add(storeVO);
                                }
                            }
                            // specify an adapter (see also next example)
                            mAdapter = new StoreRegisterAdapter(storeVOS, ChildMainChineseFood.this, new View.OnClickListener(){
                                @Override
                                public void onClick(View view) {
                                    ...
                                    if(obj!=null){
                                        ...
                                        Intent intent=new Intent(ChildMainChineseFood.this, StoreDetail.class);
