...
public class ChildMainsnackFood extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_childmain_snackfood);
        recyclerView = findViewById(R.id.erecycler_view);
...
//                                Log.d("StoreData",object.toString());
                            ...
                            mAdapter = new StoreRegisterAdapter(storeVOS, ChildMainsnackFood.this, new View.OnClickListener(){
                                @Override
                                public void onClick(View view) {
                                    ...
                                    if(obj!=null){
                                        ...
                                        Intent intent=new Intent(ChildMainsnackFood.this, StoreDetail.class);
