...
public class ChildMainwesternFood extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_childmain_westernfood);
        recyclerView = findViewById(R.id.crecycler_view);
...
//                                Log.d("StoreData",object.toString());
                            ...
                            mAdapter = new StoreRegisterAdapter(storeVOS, ChildMainwesternFood.this, new View.OnClickListener(){
                                @Override
                                public void onClick(View view) {
                                    ...
                                    if(obj!=null){
                                        ...
                                        Intent intent=new Intent(ChildMainwesternFood.this, StoreDetail.class);
