...
public class ChildMainsushi extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_childmain_sushi);
...
//                                Log.d("StoreData",object.toString());
                            ...
                            mAdapter = new StoreRegisterAdapter(storeVOS, ChildMainsushi.this, new View.OnClickListener(){
                                @Override
                                public void onClick(View view) {
                                    ...
                                    if(obj!=null){
                                        ...
                                        Intent intent=new Intent(ChildMainsushi.this, StoreDetail.class);
