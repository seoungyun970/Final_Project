...
public class ChildMyinfoUpdate extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatImage = findViewById(R.id.chatImage1);
        ...
        name=findViewById(R.id.Updatename); name.setText(loginuser.getName());
        phone=findViewById(R.id.Updatephone); phone.setText(loginuser.getPhone());
        email=findViewById(R.id.Updateemail); email.setText(loginuser.getEmail());
        adress=findViewById(R.id.Updateadress); adress.setText(loginuser.getAddr());
        ...
        if (requestCode == REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                try {
                    ...
                    in.close();
                    chatImage.setImageURI(data.getData());
    ...
    public String getImagePathToUri(Uri data) {
        ...
        Toast.makeText(ChildMyinfoUpdate.this, "이미지 이름 : " + imgName, Toast.LENGTH_SHORT).show();
    ...
    private class http  extends AsyncTask<String, String, String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(ChildMyinfoUpdate.this, "업로드 중입니다.", null, true, true);
        }
        @Override
        //2번
    ...
    private class SunhansRegisterUser extends AsyncTask<String, String, String>
    {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(ChildMyinfoUpdate.this, "정보를 업데이트 중입니다.!", null, true, true);
        }
        @Override
        protected String doInBackground(String... params) {
            try{
        ...
        protected void onPostExecute(String result)
        {
            ...
            Intent intent = new Intent(ChildMyinfoUpdate.this, ChildMyinfo.class);
