...
public class ChildMainDessert extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_childmain_dessert);
        recyclerView = findViewById(R.id.frecycler_view);
...
//                                Log.d("StoreData",object.toString());
                            ...
                            mAdapter = new StoreRegisterAdapter(storeVOS, ChildMainDessert.this, new View.OnClickListener(){
                                @Override
                                public void onClick(View view) {
                                    ...
                                    if(obj!=null){
                                        ...
                                        Intent intent=new Intent(ChildMainDessert.this, StoreDetail.class);
