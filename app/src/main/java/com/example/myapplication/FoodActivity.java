    ...
    private class FoodRegisterUser extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try{
                ...
                String _topMessage=(String) params[3];
                String _openTime=params[4];
                String _storephone=(String) params[5];
                String _foodCheck=params[6];
                String _comments=params[7];
                String _price=params[8];
                String _closeTime=(String) params[9];
                // 마감시간 12
                String _area=params[10];
                String _information=params[11];
                // 지역 13
